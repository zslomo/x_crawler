...
search = '39499922'
name = 'Tiny-Russian-Teen'
root_page = "https://www.pornhub.com/video/"
start_page = "https://www.pornhub.com/playlist/{}?page={}".format(search, start_page_num)
dist_root = 'F:\\dist\\playlist\\{}'.format(name)
# socks proxy
...
for i in range(start_page_num, end_page_num):
    ...
    while len(page_list) == 0 and k < 5:
        try:
            ...
            page_list = html.xpath('//*[@id="videoPlaylist"]/li/div[1]/div/span/a/@href')
            # print(page_list)
        except Exception as e:
            print(str(e))
            continue
    ...
    curr_page = "https://www.pornhub.com/playlist/{}?page={}".format(search, i + 1)
s.close()
